"""sforza_reformed_the_killer — OUT-OF-GRID KNOWLEDGE: what you can SENSE but cannot SEE.
...
from sea_of_colours.orchestrator_2.harnesses.sforza_reformed_the_killer.world_view import (
    _live_rows,
    _my_probe_cells,
    _tier,
)
